# forked Jenkins image

cd to dir and run `docker build -t jenkinshemo .` to install the docker image
then run `docker run -p 8080:8080 -p 50000:50000 -v jenkins_home:/var/jenkins_home jenkinshemo`
to start jenkins, it will run on `localhost:8080`
